...
if __name__ == '__main__':
    ...
    file = SpectreH('Spectre_Hd.dat')
    plot_H(plt, file.vp_real, file.vp_imag, file.residu, 6, 'r', r'Re=50')
    file = SpectreH('Spectre_Hd.dat')
    plot_H(plt, file.vp_real, file.vp_imag, file.residu, 0, 'b', r'Re=50 a')
    ...
    file = SpectreNS('Spectre_NSd_conv.dat')
    plot_NS(plt, file.vp_real, file.vp_imag, False, 6, 'r', r'Re=50')
    file = SpectreNS('Spectre_NSa_conv.dat')
    plot_NS(plt, file.vp_real, file.vp_imag, False, 0, 'b', r'Re=50 a')
