...
C     
      ...
      call setDefaultParam_nekStab
      if(nid.eq.0) call par_read_nekStab(ierr)
      call bcast(ierr,isize)
      if(ierr .ne. 0) call exitt
      call bcastParam_nekStab
      call chkParam_nekStab
      call nekgsync()

      return
      end
c-----------------------------------------------------------------------
      subroutine setDefaultParam_nekStab
      ...
      ifnois = .true.           ! add noise as initial seed 
...
c-----------------------------------------------------------------------
      subroutine par_read_nekStab(ierr)
...
c-----------------------------------------------------------------------
      subroutine par_verify_nekStab(ierr)
