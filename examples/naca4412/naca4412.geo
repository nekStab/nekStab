...
Nxr = 70;
Nxc = 22;
Transfinite Line {3, 5} = Nye/2 Using Progression 1.17;
Transfinite Line {4, 6} = Nye/2 Using Progression 1.17;
Transfinite Line {15, 19} = Nyi Using Progression 0.885;
Transfinite Line {16, 20} = Nyi Using Progression 0.885;
Transfinite Line {7, 8, 9, 17, 18} = Nxr Using Progression 1.07;
Transfinite Line {12}      = Nyi Using Progression 0.865;
Transfinite Line {21}      = Nye/2 Using Progression 0.825;
Transfinite Line {10, 13}   = 2*Nxc;
Transfinite Line {11, 14}   = 2*Nxc;
Transfinite Line {1}   = 2*Nxc Using Bump 0.15;
Transfinite Line {2}   = 2*Nxc Using Bump 0.15;
