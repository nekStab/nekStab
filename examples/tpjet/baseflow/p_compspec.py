...
if __name__ == '__main__':
    ...
    plot_H(plt, file.vp_real, file.vp_imag, file.residu, 0, 'b', r'Re=')
    ...
    plot_NS(plt, file.vp_real, file.vp_imag, False, 0, 'b', r'Re=')
    ...
    file = SpectreNS('Spectre_NS_conv.dat')
    plot_NS(plt, file.vp_real, file.vp_imag, True, 0, 'b', r'Re=')
