...
fft_probe(fl='Square.his',tsk=0.,nps=5,prb=1,fld=2,ttl=r'$x,y,z=0.25,0.25,0.$')
fft_probe(fl='Square.his',tsk=0.,nps=5,prb=2,fld=2,ttl=r'$x,y,z=0.25,0.25,0.$')
fft_probe(fl='Square.his',tsk=0.,nps=5,prb=3,fld=2,ttl=r'$x,y,z=0.25,0.25,0.$')
fft_probe(fl='Square.his',tsk=0.,nps=5,prb=4,fld=2,ttl=r'$x,y,z=0.25,0.25,0.$')
fft_probe(fl='Square.his',tsk=0.,nps=5,prb=5,fld=2,ttl=r'$x,y,z=0.25,0.25,0.$')
