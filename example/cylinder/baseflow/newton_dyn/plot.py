#!/usr/bin/env python3
"""plot.py: Visualize Newton (dynamic) base flow results.
...
NEWTON_DIR = CASE_DIR.parent / 'newton'
...
def main():
    ...
    arn_nwt, nwt_nwt = _read_newton(NEWTON_DIR)
    arn_dyn, nwt_dyn = _read_newton(CASE_DIR)
